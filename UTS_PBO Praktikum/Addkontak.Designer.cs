namespace UTS_PBO_Praktikum
{
    partial class Addkontak
    {
        ...
        private void InitializeComponent()
        {
            ...
            Textboxttlp = new TextBox();
            label_notlp = new Label();
            SuspendLayout();
            // 
            // ButtonCancel
            // 
            ...
            TextBoxJumlahFasilitas.Location = new Point(38, 195);
            ...
            TextBoxNamaFasilitas.Location = new Point(38, 114);
            ...
            Label_JumlahFasilitas.Location = new Point(31, 162);
            Label_JumlahFasilitas.Name = "Label_JumlahFasilitas";
            Label_JumlahFasilitas.Size = new Size(122, 28);
            Label_JumlahFasilitas.TabIndex = 5;
            Label_JumlahFasilitas.Text = "Email Orang";
            // 
            // Label_NamaFasilitas
            // 
            ...
            Label_NamaFasilitas.Location = new Point(31, 81);
            Label_NamaFasilitas.Name = "Label_NamaFasilitas";
            Label_NamaFasilitas.Size = new Size(127, 28);
            Label_NamaFasilitas.TabIndex = 4;
            Label_NamaFasilitas.Text = "Nama Orang";
            // 
            // Textboxttlp
            // 
            Textboxttlp.BackColor = Color.FromArgb(109, 106, 117);
            Textboxttlp.BorderStyle = BorderStyle.None;
            Textboxttlp.Font = new Font("Segoe UI Semibold", 13F, FontStyle.Bold);
            Textboxttlp.ForeColor = Color.FromArgb(249, 249, 249);
            Textboxttlp.Location = new Point(38, 282);
            Textboxttlp.Name = "Textboxttlp";
            Textboxttlp.Size = new Size(250, 24);
            Textboxttlp.TabIndex = 9;
            // 
            // label_notlp
            // 
            label_notlp.AutoSize = true;
            label_notlp.BackColor = Color.Transparent;
            label_notlp.Font = new Font("Segoe UI Semibold", 15F, FontStyle.Bold);
            label_notlp.ForeColor = Color.FromArgb(249, 249, 249);
            label_notlp.Location = new Point(31, 249);
            label_notlp.Name = "label_notlp";
            label_notlp.Size = new Size(73, 28);
            label_notlp.TabIndex = 8;
            label_notlp.Text = "No Tlp";
            // 
            // Addkontak
            // 
            ...
            Controls.Add(Textboxttlp);
            Controls.Add(label_notlp);
        ...
        private TextBox Textboxttlp;
        private Label label_notlp;
    }
}